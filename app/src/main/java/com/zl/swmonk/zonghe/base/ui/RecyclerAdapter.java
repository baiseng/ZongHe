...
public abstract class RecyclerAdapter<Data>
     ...
     * @param data Data
     */
    public void addOnStart(Data data) {
        mDataList.add(data);
        notifyItemInserted(0);
    }

    /**
     * 插入一堆数据在最前面，并通知这段集合更新
     *
     * @param dataList Data
     */
    public void addOnStart(Data... dataList) {
        if (dataList != null && dataList.length > 0) {
            Collections.addAll(mDataList, dataList);
    ...
    /**
     * 插入一堆数据在开始处，并通知这段集合更新
     *
     * @param dataList Data
     */
    public void addOnStart(Collection<Data> dataList) {
        if (dataList != null && dataList.size() > 0) {
